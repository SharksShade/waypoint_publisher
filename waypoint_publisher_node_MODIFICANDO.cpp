...
void poseCallback(const geometry_msgs::PoseStamped::ConstPtr& msg)
{
    ...
    pose_msg.pose.pose.position.x = pose_msg.pose.pose.position.x - current_map.pose.pose.position.x;
    pose_msg.pose.pose.position.y = pose_msg.pose.pose.position.y - current_map.pose.pose.position.y;
    pose_msg.pose.pose.position.z = pose_msg.pose.pose.position.z - current_map.pose.pose.position.z;

    pose_msg.pose.pose.orientation = current_odom.pose.pose.orientation; // MANTENGO LA ORIENTACION QUE TENIA.
